对于每个频段而言，需要以下几个统计图表：干扰BSS数量的分布图，横轴是数量区间，纵轴是网络个数；干扰BSS强度的分布图，横轴是强度区间，纵轴是干扰BSS的数量；干扰BSS的信道分布图，横轴是信道，纵轴是干扰BSS的数量；干扰BSS的带宽分布图，横轴是带宽，纵轴是干扰BSS的数量；环境Congestion Rate的分布图，横轴是Congestion Rate的区间，纵轴是网络个数
...
n 界定系统的对外提供的功能（将对应于概要设计中的模块接口或系统界面）；

n 详细的功能项及功能的分类（将对应于概要设计中的模块划分）；

n 功能分类之间的关系（将对应于概要设计中的模块关系）；

n 功能的作用或流程（将对应于概要设计中的模块内部建模）；

n 提供上述功能时需要达到的性能（将影响概要设计中协议、算法等的选择）。
